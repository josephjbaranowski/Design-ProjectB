...
@Component({
  selector: 'app-topnavlayout',
  templateUrl: './topnavlayout.component.html',
  styleUrls: ['./topnavlayout.component.scss']
})
export class TopnavlayoutComponent implements OnInit {  public doughnutChartLabels: string[] = [ 'BUTT', 'DANGIT'];
